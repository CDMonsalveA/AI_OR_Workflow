...
def crear_estructura_de_archivos():
    ...
    try:
        ...
        os.makedirs("resultados/tablas/solucionar_cflp", exist_ok=True)
        os.makedirs("resultados/tablas/solucionar_cflp/soluciones", exist_ok=True)
        os.makedirs("resultados/tablas/solucionar_cflp/metricas", exist_ok=True)
